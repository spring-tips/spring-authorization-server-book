...
Remember, the user visting the HTML page won't even see any of this markup unless they've authenticated. They'll be redirected away before they ever get a chance. So not only is this page completely unaware of security, it doesn't need to be.
