...
We can get one because, when we registerde the client with the Spring Authorization Server, we listed `client_credentials` as an authorized grant type.
